...
API_ID = int(environ.get('API_ID', '22547296'))
API_HASH = environ.get('API_HASH', '0517a17b7614e626a9336bfa145eb70c')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002396439681'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6576677273').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vinod974323:ohIioHMRKipvrgkL@cluster0.s36yo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://vinod974323:ohIioHMRKipvrgkL@cluster0.s36yo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', '1002430911717') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
